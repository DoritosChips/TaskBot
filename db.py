...
def getTask(connection: pymysql.connections.Connection, user_id: int, task_id: int) -> Task:
    cursor = connection.cursor()
...
def getEvent(connection: pymysql.connections.Connection, user_id: int, event_id: int) -> Event:
    cursor = connection.cursor()
...
def getReminders(connection: pymysql.connections.Connection, user_id: int = None, task_id: int = None) -> list[Reminder]:
    cursor = connection.cursor()
...
def createTask(connection: pymysql.connections.Connection, user_id: int, title: str, desc="") -> None:
    cursor = connection.cursor()
    current_task_id = 0
    while True:
...
def createEvent(connection: pymysql.connections.Connection, user_id: int, title: str, start: datetime, end: datetime) -> None:
    cursor = connection.cursor()
    current_event_id = 0
    while True:
...
def createReminder(connection: pymysql.connections.Connection, user_id: int, title: str, remind_time: datetime, task_id=-1, event_id=-1) -> None:
    cursor = connection.cursor()
...
def deleteTask(connection: pymysql.connections.Connection, user_id: int, task_id: int) -> None:
    cursor = connection.cursor()
...
def deleteEvent(connection: pymysql.connections.Connection, user_id: int, event_id: int) -> None:
    cursor = connection.cursor()
...
def deleteReminders(connection: pymysql.connections.Connection, user_id: int, event_id=-1, task_id=-1) -> None:
    cursor = connection.cursor()
    if task_id!=-1:
...
def deleteReminder(connection: pymysql.connections.Connection, reminder_id: int) -> None:
    cursor = connection.cursor()
...
def main():
    ...
    deleteTask(connection, 296691655, 0)
